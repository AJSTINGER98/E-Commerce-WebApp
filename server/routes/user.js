...
router.post('/data/edit', (req,res)=>{
  ...
  User.findOneAndUpdate({_id:userId, 'address_location':req.body.data.adaress.location},{$set: {phone:req.body.data.phone, 'address.$.location': req.body.data.address.location,
